...
@Service
public class DBService { // Criei essa classe para testes 
	
	@Autowired
	private BCryptPasswordEncoder pv;
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null,"Automobilismo");
		...
		Categoria cat7 = new Categoria(null,"Celulares e Notebooks");
		...
		Endereco e2 = new Endereco(null,"Avenida Parada Pinto","300","Apto 303","Jardim","02447195",cli1,c2);
		Endereco e3 = new Endereco(null,"Avenida Engenheiro Caetano Alvares","450","Apto 303","Jardim","02456898",cli2,c2);
